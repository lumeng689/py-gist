...
class DownloadVuePress2Pdf:
    ...
    def get_content_and_next_url(self, content):
        ...
        print("=======")
        print(next_span_href)
        return soup.prettify(), next_span_href


down = DownloadVuePress2Pdf("http://localhost/docs", "开发文档",
                            wkhtmltopdf="C:/dev/wkhtmltopdf/bin/wkhtmltopdf.exe", save_html_path="./files", save_pdf_path='./out')
